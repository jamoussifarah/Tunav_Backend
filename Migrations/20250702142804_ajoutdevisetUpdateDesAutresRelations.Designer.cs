...
namespace TunavBackend.Migrations
{
    ...
    [Migration("20250702142804_ajoutdevisetUpdateDesAutresRelations")]
    partial class ajoutdevisetUpdateDesAutresRelations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TunavBackend.Models.Devis", b =>
                {
                    b.HasOne("TunavBackend.Models.ProduitAvecDevis", "ProduitAvecDevis")
                        .WithMany("Devis")
                        .HasForeignKey("ProduitAvecDevisId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
